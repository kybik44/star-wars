import type { EntityConfig, FieldConfig, FormFieldConfig } from '../types';

// Helper functions for creating field configurations
const createBasicField = (key: string, label: string, unit?: string): FieldConfig => ({
  key,
  label,
  type: 'text',
  unit,
...
const createArrayField = (key: string, label: string): FieldConfig => ({
  key,
  label,
  type: 'array',
...
export const charactersConfig: EntityConfig = {
  type: 'characters',
  name: 'Character',
  ...
  formFields: [
    ...
    createFormField('height', 'Height (cm)', 'text', undefined, true, 'Enter height in centimeters or "unknown"'),
    createFormField('mass', 'Mass (kg)', 'text', undefined, true, 'Enter mass in kilograms or "unknown"'),
    createFormField('birth_year', 'Birth Year', 'text', undefined, true, 'e.g., "19BBY", "112BBY", "unknown"'),
    createFormField('gender', 'Gender', 'select', [
    ...
    createFormField('hair_color', 'Hair Color', 'text', undefined, true),
    createFormField('skin_color', 'Skin Color', 'text', undefined, true),
    createFormField('eye_color', 'Eye Color', 'text', undefined, true),
  ],
};

// Film configuration
export const filmsConfig: EntityConfig = {
  type: 'films',
  name: 'Film',
  pluralName: 'Films',
  endpoint: '/films',
  ...
  formFields: [
    ...
    createFormField('release_date', 'Release Date', 'text', undefined, true, 'Format: YYYY-MM-DD'),
    createFormField('opening_crawl', 'Opening Crawl', 'textarea', undefined, false, 'The opening crawl text'),
  ],
};

// Planet configuration
export const planetsConfig: EntityConfig = {
  type: 'planets',
  name: 'Planet',
  pluralName: 'Planets',
  endpoint: '/planets',
  ...
  formFields: [
    createFormField('name', 'Name', 'text', undefined, true),
    createFormField('rotation_period', 'Rotation Period', 'text', undefined, true, 'Enter in hours or "unknown"'),
    createFormField('orbital_period', 'Orbital Period', 'text', undefined, true, 'Enter in days or "unknown"'),
    createFormField('diameter', 'Diameter', 'text', undefined, true, 'Enter in kilometers or "unknown"'),
    ...
    createFormField('surface_water', 'Surface Water', 'text', undefined, true, 'Enter percentage or "unknown"'),
    createFormField('population', 'Population', 'text', undefined, true, 'Enter population number or "unknown"'),
  ],
};

// Starship configuration
export const starshipsConfig: EntityConfig = {
  type: 'starships',
  name: 'Starship',
  ...
  formFields: [
    ...
    createFormField('cost_in_credits', 'Cost in Credits', 'text', undefined, true, 'Enter cost or "unknown"'),
    createFormField('length', 'Length', 'text', undefined, true, 'Enter in meters or "unknown"'),
    createFormField('max_atmosphering_speed', 'Max Atmosphering Speed', 'text', undefined, true, 'Enter speed or "n/a"'),
    createFormField('crew', 'Crew', 'text', undefined, true, 'Enter crew size or "unknown"'),
    createFormField('passengers', 'Passengers', 'text', undefined, true, 'Enter passenger capacity or "unknown"'),
    createFormField('cargo_capacity', 'Cargo Capacity', 'text', undefined, true, 'Enter cargo capacity or "unknown"'),
    createFormField('consumables', 'Consumables', 'text', undefined, true, 'e.g., "3 years", "1 month"'),
    createFormField('hyperdrive_rating', 'Hyperdrive Rating', 'text', undefined, true, 'Enter rating or "n/a"'),
    createFormField('MGLT', 'MGLT', 'text', undefined, true, 'Enter MGLT or "n/a"'),
    createFormField('starship_class', 'Starship Class', 'text', undefined, true),
  ],
};

// Species configuration (Coming Soon)
export const speciesConfig: EntityConfig = {
  type: 'species',
  name: 'Species',
  pluralName: 'Species',
  endpoint: '/species',
